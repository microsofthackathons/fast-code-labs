...
export const styles: ElementStyles = css`
  ...
  .lab-step aside.callout b {
    color: #4f7dc9;
  }

  .lab-step ul.checklist {
    list-style: none;
    padding: 0 0 0 1em;
  }

  .lab-step ul.checklist li {
    padding-left: 24px;
  ...
  .lab-step paper-button a {
    text-decoration: none;
    color: inherit !important;
  }

  .lab-step paper-button.colored {
    background-color: #0f9d58;
    color: #fff;
  }

  .lab-step paper-button.red {
  ...
  .lab-step .faq a:hover {
    text-decoration: underline;
  }

  .lab-step .faq a[href*='cloud.google.com'] {
    padding-left: 22px;
    background-size: 20px;
    background-repeat: no-repeat;
  ...
  .lab-step .faq a[href*='stackoverflow.com'] {
    padding-left: 22px;
  ...
  .lab-step .faq a[href*='support.google.com/webmasters/'] {
    padding-left: 24px;
    background-size: 24px;
    background-repeat: no-repeat;
  ...
  .lab-step .faq a[href*='developer.android.com'],
  .lab-step .faq a[href*='android-developer'] {
    padding-left: 20px;
    background-repeat: no-repeat;
    background-size: 20px;
  ...
  .lab-step h3 > a[href*='github'],
  .lab-step h3 > a[href*='github']:visited {
    color: black;
    text-decoration: none;
    padding-left: 24px;
    background-repeat: no-repeat;
